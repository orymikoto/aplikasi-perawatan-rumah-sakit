...
@section('content')
  <div class="flex flex-col justify-start items-start gap-6 h-full overflow-x-clip relative">
    ...
    <h2 class="text-2xl text-center mx-auto text-neutral-900 font-josefin-sans">Rekapitulasi SHRI
      ...
      <table class="rounded-t-2xl w-full min-h-full flex-1 shadow-md overflow-hidden table ">
        <thead>
          <tr class="text-white font-josefin-sans font-medium text-lg bg-emerald-600">
            ...
            <th rowspan="2" class="px-4 text-center min-w-32 border border-white ">Tanggal</th>
            <th rowspan="2" class="px-4 text-start w-24 border border-white">Pasien Awal</th>
            <th rowspan="2" class="px-4 text-start w-24 border border-white">Pasien Baru</th>
            <th rowspan="2" class="px-4 text-center w-24 border border-white">Pindahan</th>
            <th rowspan="2" class="px-4 text-center w-24">Jumlah Pasien Masuk</th>
            <th rowspan="2" class="px-4 text-center w-24 border border-white">Pasien Keluar Hidup</th>
            <th rowspan="2" class="px-4 text-center w-24 border border-white">Pasien Dipindahkan</th>
            <th colspan="2" class="px-4 text-center w-64 border border-white">Pasien Mati</th>
            <th rowspan="2" class="px-4 text-center w-24 border border-white">Jumlah Pasien Keluar</th>
            <th rowspan="2" class="px-4 text-center w-24 border border-white">Pasien Sisa</th>
            {{-- <th class="px-4 text-center w-16">Aksi</th> --}}
          </tr>
          <tr class="text-white font-josefin-sans font-medium text-lg bg-emerald-600">
            <th class="px-4 text-center border border-white min-w-32"> {{ '< 48 Jam' }}</th>
            <th class="px-4 text-center border border-white min-w-32"> {{ '> 48 Jam' }}</th>
            {{-- <th class="px-4 text-center w-16">Aksi</th> --}}
          </tr>
        </thead>
