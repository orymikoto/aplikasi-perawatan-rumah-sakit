...
@section('content')
    <div class="flex flex-col justify-start items-start gap-6">
        ...
        <form action="{{ route('pasiens.store') }}" class="flex flex-col gap-2 p-4 rounded-2xl shadow-md xl:w-[540px] "
            method="POST">
            @csrf
            <div class="flex flex-col gap-2 font-jakarta-sans">
                <div class="flex gap-x-2 items-end">
                    ...
                    <button type="button" id="cek_rm"
                        class="bg-yellow-600 hover:bg-yellow-500 duration-200 rounded-md px-4 py-2 text-white">Cek</button>
                    <button type="reset" id="pasien_baru"
                        class="bg-teal-600 hover:bg-teal-500 duration-200 rounded-md px-4 py-2 text-white">Pasien
                        Baru</button>
                </div>
    ...
    <script>
        ...
        const input_tanggal_daftar = document.getElementsByName("tanggal_daftar")[0].readOnly = true;
        ...
        cek_rm.onclick = function() {
            ...
            fetch(`/pasiens/check-rm/${nomor_rm}`, {
                ...
                if (!res.error) {
                    ...
                    .jenis_kelamin;
                    let tanggal_daftar = document.getElementsByName('tanggal_daftar')[0].value = res
                        .tanggal_daftar.substring(0, 10);
        ...
        pasien_baru.onclick = function() {
            ...
            document.getElementsByName("tanggal_daftar")[0].readOnly = false;
