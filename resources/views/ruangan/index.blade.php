    ...
    <table class="rounded-t-2xl w-full min-h-full flex-1 shadow-md overflow-hidden table ">
      ...
      <tbody>
        @forelse ($data_ruangans as $data_ruangan)
          <tr data-entry-id="{{ $data_ruangan->id }}" class="h-12 text-lg font-josefin-sans font-medium text-neutral-800">
            ...
            <td class="px-4">
              <div class="flex gap-2 mx-auto justify-center">
                ...
                <a href="{{ route('ruangan.edit', $data_ruangan->id) }}" class="bg-teal-600 text-white hover:bg-teal-500 p-1 px-2 rounded-md">
