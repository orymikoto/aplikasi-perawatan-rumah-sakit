...
@section('content')
    <div class="flex flex-col justify-start items-start gap-6">
        ...
        <form class="flex flex-col gap-4 p-4 rounded-2xl shadow-md xl:w-[480px]" action="{{ route('ruangan.store') }}"
            method="POST">
            @csrf
            ...
            <x-input.number title="Jumlah tempat tidur" name="jumlah_tempat_tidur" placeholder="Jumlah tempat tidur..."
                value="" />
            <x-input.select title="Kelas" name="kelas" placeholder="Pilih jenis kelas" value=""
                :options="['Paviliun', 'Kelas 1', 'Kelas 2', 'Kelas 3', 'Non Kelas', 'Isolasi']" />
